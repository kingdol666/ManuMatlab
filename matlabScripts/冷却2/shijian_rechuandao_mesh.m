try
    % Check for the existence of necessary input variables
    if ~exist('L', 'var') || ~exist('H', 'var') || ~exist('Nx', 'var') || ~exist('Ny', 'var')
        error('MATLAB:InputError', 'One or more required variables (L, H, Nx, Ny) were not provided to the script.');
    end
